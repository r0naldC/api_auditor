...
namespace endpoint_generator
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var folder = "C:\\Users\\ProgramacionA\\Documents\\Proyectos\\Git_TvCable\\ApiOficable\\Controllers";
            ...
            foreach (var file in files)
            {
                ...
                foreach (var cls in root.DescendantNodes().OfType<ClassDeclarationSyntax>())
                {
                    ...
                    foreach (var method in cls.Members.OfType<MethodDeclarationSyntax>())
                    {
                        ...
                        //var fullUrl = BuildUrl(baseUrl, fullTemplate, method.ParameterList.Parameters);
            ...
            File.WriteAllText("rutas_generadas.txt", sb.ToString(), Encoding.UTF8);
            Console.WriteLine($"Generadas {results.Count} rutas.");
        }
        ...
        //static string BuildUrl(string baseUrl, string template, SeparatedSyntaxList<ParameterSyntax> parameters)
        //{
        //    var url = template;
